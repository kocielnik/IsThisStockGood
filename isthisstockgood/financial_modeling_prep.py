...
class FinancialModelingPrep:
  ...
  STOCKROW_KEY_STATS_URL = (
    'https://financialmodelingprep.com/api/v3/key-metrics'
    '/{}?period=annual&apikey={}'
  )

  def __init__(self, ticker_symbol, key=None):
    ...
    self.key_stat_url = self.STOCKROW_KEY_STATS_URL.format(ticker_symbol, key)
